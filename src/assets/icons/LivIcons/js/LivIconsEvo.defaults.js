...
function LivIconsEvoDefaults () {
	...
	var defaultOptions = {
		...
		pathToFolder: 'http://ea84c204.ngrok.io/icons/LivIcons/svg', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
